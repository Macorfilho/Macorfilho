...
### 🥇 SPI + ABDI Gen AI Challenge 2024
**1st Place**

We developed an AI-powered robot capable of recognizing, picking, and transporting objects efficiently. The project demonstrated practical application of:
...
### 🥇 Raízen Smart Mobility Challenge 2023

**1st Place**

We created an innovative mobile application that enables reading, processing, and intuitive display of data from cars manufactured after 2002.

**Technologies:** React Native, OBD-II APIs, UI/UX Design

**Impact:** Optimization of user experience and vehicle management
...
- Real-time monitoring with instant failure response
- NewSon - AI Assistant that democratizes technical knowledge
...
- Emotion analysis via Vertex AI to support people with ASD
- Real-time image recognition (Gemini)
- Natural audio description (CHIP3)

**Technologies:** React, Google Cloud, Gemini, Vertex AI, CHIP3

**Team:** Amanda Ballet, Lucas Moreira, Maria Eloisa, Pedro Nascimento
...
💼 I'm always open to discussing technology, innovative projects, or collaboration opportunities!
...
<div align="center">
  ...
  <p>⭐ If you found it interesting, leave a star on the repositories!</p>
  <p>💡 <i>Created with dedication by Marcelo Rodriguez Corner Filho</i></p>
</div>
